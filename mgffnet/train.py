...
from models.MGFFNet import MGFFNet
from config import Config
from utils.process import RandCrop, ToTensor, Normalize, five_point_crop, split_dataset_livec, split_dataset_live
from utils.process import  RandHorizontalFlip
...
if __name__ == '__main__':
    ...
    config = Config({
        ...
        # live
        "live_path": "/root/workspace/Database/databaserelease2/",
        "live_label": "/root/workspace/Database/databaserelease2/dis_image_all_live.txt",

        # LIVEC
        "livec_path": "/root/workspace/Database/ChallengeDB_release/Images/",
        "livec_label": "/root/workspace/Database/ChallengeDB_release/image_all.txt",
    ...
    if config.dataset_name == 'livec':
        ...
        from data.live.live import Live
